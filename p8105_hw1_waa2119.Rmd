...
We see that the mean of the random sample is `r avg_rand_samp`, but we are unable to calculate the mean of the logical vector: `r avg_log_vec`, mean of character vector: `r avg_char_vec`, and mean of factor vector: `r avg_fact_vec` as they are not numerical values
